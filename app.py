...
#    elif '海軍馬公軍港' in msg:
   ...
   #地面作戰部隊簡介   
    ...
    #地面一般部隊介紹
        ...
        message = TextSendMessage(text="🎺海軍司令部勤務大隊🎺\n🗒︎單位沿革🗒︎\n    ⚓️民國102年7月1日更銜為「海軍勤務大隊」。大隊現下轄有勤務隊、汽車隊、軍樂隊、警衛連(儀隊)等4個連隊，負責海軍司令部大直營區之安全警衛與自衛戰鬥指揮、司令部各幕僚單位暨本軍北部地區行政勤務支援、連隊內部管理及教育訓練工作。\n \n🏘區域🏘\n北部地區\n \n⚔️指揮體系⚔️\n汽車隊(北部)\n勤務隊(北部)\n樂隊(北部)\n儀隊(北部)\n \n \n💰薪資待遇💰\n儀隊加給：3000-5000元\n \n💎各階待遇💎\n士兵起薪：35320元\n士官起薪：41450元\n軍官起薪：50560元" )
        line_bot_api.reply_message(event.reply_token, message)
    elif '%大氣'in msg:     
        ...
        message = TextSendMessage(text="🎖 海軍軍官學校 🎖\n🗒︎單位沿革🗒︎\n    ⚓️我國近代海軍教育，起源於清同治年間，先有船政機構的設立，繼而於馬尾成立前後學堂，后因需才孔急，海軍學校紛起，各艦隊自辦學校，惟各校組織相異，目的有別，及至抗戰勝利後，本於黃埔建軍之革命精神，統一教育體制之理念，於上海成立新制海軍軍官學校並合併其它各校，參照美國海軍軍官學校學制辦理校務，因應局勢遷至山東青島、後遷廈門；另民國38年8月因中共南下，廈門告急，乃於38年8月29日及9月12日分2梯次將人員、卷籍及裝具，搭乘中練與中海軍艦遷抵現址南部迄今🎖\n \n🏘︎區域🏘︎\n南部地區\n\n\n💰薪資待遇💰\n助教勤務加給：2300元\n教官勤務加給：4100元\n \n💎各階待遇💎\n士兵起薪：35320元\n士官起薪：44450元\n軍官起薪：53560元" )
        line_bot_api.reply_message(event.reply_token, message)
    #海軍陸戰隊介紹    
    elif '%66'in msg:     
        ...
        message = TextSendMessage(text="💂‍♂️海軍陸戰隊防空警衛群💂‍♀️\n🗒︎單位沿革🗒︎\n    負責中華民國海軍各海軍基地之警衛勤務，故本單位代號「鐵衛」部隊。肩負海軍重要軍港、高山站台防空任務，分別由警衛營與防空營組成，警衛營分部北、中、南、宜花東及澎湖等地區為主，較為特色哨點分布高山地區計有小雪山、阿里山、火炎山雷達站等，有天空之城名號的優質環境；防空營分布於北部與南部等地區，單位較具特色，防空建制武器為檞樹飛彈及刺針飛彈兩大防空武器系統，捍衛責任區域領空。\n   \n⚔️指揮體系⚔️\n群支援排（南部地區）\n基地警衛第一營（營支援排＋警衛連×3）\n    警衛第一連(南部地區)\n    警衛第二連(南部地區)\n    警衛第三連(離島地區)\n基地警衛第二營（營支援排＋警衛連×3) \n    警衛第四連(北部地區)\n    警衛第五連(北部地區)\n    警衛第六連(北部地區)\n防空營（營支援排＋防空連×4 各連分散駐防在北部及南部地區）\n    防空第一連(南部地區)\n    防空第二連(南部地區)\n    防空第三連(北部地區)\n    防空第四連(北部地區)\n \n\n💰薪資待遇💰\n警衛營戰鬥加給：3000元\n防空營戰鬥加給：5000元\n \n💎各階待遇💎\n警衛營士兵起薪：38320元\n防空營士兵起薪：40320元\n警衛營士官起薪：44450元\n防空營士官起薪：46450元\n警衛營軍官起薪：53560元\n防空營軍官起薪：55560元" )
        line_bot_api.reply_message(event.reply_token, message)
    elif '%三軍基地'in msg:     
