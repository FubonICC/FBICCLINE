...
def imagemap_message():
    message = ImagemapSendMessage(
        base_url="https://static.wixstatic.com/media/f96bc7_e631f625a59c4bccabbadad6d6cd0ecf~mv2.jpg/v1/fill/w_357,h_228,al_c,q_80,usm_0.66_1.00_0.01/recuitmenu01.webp",
        alt_text='最新的合作廠商有誰呢？',
        base_size=BaseSize(height=228, width=356),
        actions=[
            URIImagemapAction(
                #家樂福
                link_uri="https://tw.shop.com/search/%E5%AE%B6%E6%A8%82%E7%A6%8F",
                area=ImagemapArea(
                    x=0, y=0, width=148, height=114
                )
            ),
            URIImagemapAction(
                #生活市集
                ...
                area=ImagemapArea(
                    x=148, y=0, width=148, height=114
                )
            ),
            URIImagemapAction(
                #阿瘦皮鞋
                ...
                area=ImagemapArea(
                    x=0, y=114, width=148, height=114
                )
            ),
            URIImagemapAction(
                #塔吉特千層蛋糕
                ...
                area=ImagemapArea(
                    x=148, y=114, width=148, height=114
                )
            ),
        ]
    )
